...
int main(int argc, char *argv[])
{
...
#ifdef HAVE_LIBUSB
    //Nimo Add
    applog(LOG_ERR,"[Nimo]Enter HAVA_LIBUSB");
    //End
...
#endif
    //Nimo Add
    applog(LOG_ERR,"[Nimo]Started?");
    applog(LOG_ERR,"[Nimo]cnfbuf=%s",cnfbuf);
    //End
    ...
    //Nimo Add
    applog(LOG_ERR,"[Nimo]devices_enabled=%d",devices_enabled);
    //End
